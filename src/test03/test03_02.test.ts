...
test("Greeting sholhd be correct for city", () => {
   let messege =  createMessege(city);
  
    expect(messege).toBe("Hello New York citizens.I wont you be happy.All 10000000");
  });
